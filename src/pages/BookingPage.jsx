...
const BookingPage = () => {
  ...
  async function getRoomData() {
    ...
    try {
      const response = await axios.get(
        `${backend}/rooms/room-type/search?check_in_date=${checkInDate}&check_out_date=${checkOutDate}&amount_guests=${guests}`
      );
  ...
  async function getMaximam() {
    const backend = import.meta.env.VITE_BACKEND_URL;
    try {
      const response = await axios.get(`${backend}/rooms/room-type/max-guests`);
